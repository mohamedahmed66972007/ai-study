...
- [[نص بين قوسين مربعين مزدوجين]] = اللفظة/العبارة التي هي **الإجابة المباشرة** على السؤال (المصطلح المطلوب تحديدًا، أو الخيار الصحيح، أو الرقم/التاريخ المطلوب). ستظهر بلون مميز وحجم أكبر. استخدمها مرة أو مرتين فقط في كل إجابة، للكلمة الجوهرية التي يبحث عنها الطالب فعلاً.
- استخدم سطرًا جديدًا بين الفقرات، واستخدم قوائم مرقّمة أو نقطية (- ) عند تعداد عدة أمور.
- لا تستخدم أي تظليل بلون أصفر أو علامات == مطلقًا.
...
- [[نص بين قوسين مربعين مزدوجين]] = اللفظة/العبارة التي هي **الإجابة المباشرة** على السؤال (المصطلح المطلوب، الخيار الصحيح، الرقم، التاريخ، …). ستظهر بلون مميز وحجم أكبر. استخدمها مرة أو مرتين فقط لكل إجابة، للكلمة الجوهرية التي يبحث عنها الطالب.
